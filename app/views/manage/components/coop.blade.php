{{ bForm::setType('basic')->open(false, array('url' => '/manage/add-coop/'. $video->id .'/'. $roundId, 'id' => 'winnersForm')) }}
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">{{ $video->title }} Co-Op Stats</div>
				<div class="panel-body">
					<div id="winners">
						{{ Form::hidden('type', null, array('id' => 'type')) }}
						@if ($roundId != null && isset($round) && $round->coopStat != null)
							<div class="row">
								<div class="col-md-12">
									{{ bForm::select('status', array('LOSS' => 'Lost', 'WON' => 'Won'), $round->coopStat->status) }}
								</div>
							</div>
						@else
							<div class="row" id="template">
								<div class="col-md-12">
									{{ bForm::select('status', array('LOSS' => 'Lost', 'WON' => 'Won'), null) }}
								</div>
							</div>
						@endif
					</div>
